...
create table custmer_tab(id INT, name varchar(50), description(250));
create table custmer_tab(id INT, name varchar(50), description TEXT);

-- 4. Query Execution Plans
explain select id, name, purchase_amount from messy_indian_dataset
